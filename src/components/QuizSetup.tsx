          ...
          <div className="flex items-center gap-2 mb-4 pb-3 border-b border-slate-100">
            ...
            <div>
              ...
              <p className="text-xs text-slate-500">
                Lựa chọn mô hình trí tuệ nhân tạo Gemini phù hợp với nhu cầu và tốc độ mong muốn
              </p>
            </div>
          </div>
            ...
            {AVAILABLE_MODELS.map((m) => {
              ...
              return (
                ...
                >
                  ...
                  <div className="mt-4 pt-2.5 border-t border-slate-100 flex items-center gap-2 text-[11px] font-medium">
                    <span
